...
use Vsb\Pne\Classes\HTTPResponse;
use Vsb\Pne\Classes\Pne\Exception;
...
class Response extends HTTPResponse{
    ...
    public function check(){
        ...
        if($this->buildChecksum()!==$this->_params["control"]) throw new Exception("Checksum is invalid",500);
